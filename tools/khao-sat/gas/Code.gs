...
var CONFIG = {
  ...
  FOLDER_NAME   : 'ReverseEngine — Khảo sát & Đánh giá',
  SPREADSHEET   : 'ReverseEngine — CSDL Khảo sát & Đánh giá',
  ...
  TEACHER_EMAIL : '',
  BASE_URL      : 'https://aerovfx.github.io/ReverseEngine/tools/khao-sat/',
  ROSTER_URL    : 'https://aerovfx.github.io/ReverseEngine/tools/khao-sat/data/students.json',
  COURSES_URL   : 'https://aerovfx.github.io/ReverseEngine/tools/khao-sat/data/courses.json'
};
