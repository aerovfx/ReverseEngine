/* ReverseEngine — shared top navigation for classroom tools. */
(function () {
  'use strict';
  var items = [
  ...
  function boot() {
    ...
    nav.innerHTML = '<a class="science-nav-brand" href="../../index.html" aria-label="ReverseEngine">' +
      '<span>R</span><b>ReverseEngine</b></a>' +
